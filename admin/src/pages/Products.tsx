...
const Products = () => {
  ...
  const handleAddProduct = async (data: FormData) => {
    ...
    try {
      ...
      // Reset về page 1 và fetch lại product
      fetchProducts(true);
                ...
                <TableBody>
                  {products.map((product, index) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <span className='inline-flex items-center rounded-full bg-orange-100 px-2 py-2 text-xs font-medium text-medium text-orange-800 whitespace-nowrap'>
                      ...
                      <TableCell>
                        <span
                          ...
                          whitespace-nowrap ${product.stock > 10
