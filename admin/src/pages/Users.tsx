...
const UsersPage = () => {
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      toast("User deteled successfully");
    ...
    <div className='p-5 space-y-5'>
                    ...
                    <div className='-mt-8'>
                      ...
                      <p className='text-sm text-gray-500 mt-1 max-w-sm mx-auto'>
                        {searchTerm || roleFilter !== "all"
                          ...
                          : "The user directory is empty or you don't have permission to access these records."}
                      </p>
                    </div>
                  </div>
                </TableCell>
      ...
      <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
        <DialogContent className='sm:max-w-[550px] max-h-[90vh] overflow-y-auto'>
          ...
          <Form {...formAdd}>
            <form onSubmit={formAdd.handleSubmit(handleAddUser)} className='space-y-6 mt-4'>
              {/*  */}
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger
                          className='border-gray-300 rounded-lg focus:ring-2 focus: ring-indigo-500 focus:border-indigo-500  transition-all duration-200 w-full'
                        >
                          <SelectValue
        ...
        <DialogContent>
          ...
          {selectedUser && (
            <div className='space-y-6'>
              <div className='flex items-center gap-4'>
                <div className='h-20 w-20 rounded-full bg-blue-100 flex
                items-center justify-center text-blue-600 font-semibold shadows-sm
                overflow-hidden'>
                  {selectedUser.avatar ? (
                    <img
