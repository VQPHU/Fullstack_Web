...
import { Baby, Heart, HelpCircle, Home, Package, Phone, ShoppingBag, Star, Store, Tag, Truck, User, UserCircle, X } from 'lucide-react';
...
const HeaderLeftSidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div
            className={`fixed inset-y-0 h-screen left-0 z-50 w-full bg-babyshopBlack/50 shadow-xl transform ${isOpen ? "translate-x-0" : "-translate-x-full"
        ...
        >
            <motion.div
                ...
                ref={sidebarRef}
                className="min-w-72 max-w-96 bg-babyshopWhite text-babyshopBlack z-50 h-screen
                 border-r border-r-babyshopRed flex flex-col gap-6 relative"
            >
